...
const disclosureData = [
  ...
  },
  {
    ...
    items: [
      { label: "Copies of Affiliation/Upgradation Letter and Recent Extension of Affiliation, if any", value: <a href="/Documents/AFFILIATION%20LETTER.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">Affiliation Letter</a> },
      { label: "Copies of Societies/Trust/Company Registration/Renewal Certificate", value: <a href="/Documents/TRUST%20CERTIFICATE.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">Trust Certificate</a> },
      { label: "Copy of No Objection Certificate (NOC)", value: <a href="/Documents/NOC.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">NOC</a> },
      { label: "Copies of Recognition Certificate under RTE Act, 2009", value: <a href="/Documents/RECOGNITION%20CERTIFICATE.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">Recognition Certificate</a> },
      { label: "Copy of Valid Building Safety Certificate", value: <a href="/Documents/BUILDING%20CERTIFICATE.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">Building Certificate</a> },
      { label: "Copy of Valid Fire Safety Certificate", value: <a href="/Documents/FIRE%20CERTIFICATE.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">Fire Certificate</a> },
      { label: "Copy of the DEO Certificate", value: <a href="/Documents/DEO%20CERTIFICATE.pdf" target="_blank" rel="noopener noreferrer" className="inline-block bg-primary text-primary-foreground font-semibold px-4 py-2 rounded-md shadow-sm hover:bg-primary/80 transition">DEO Certificate</a> },
    ],
  },
    {
